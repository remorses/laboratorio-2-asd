//Nome: Rodolfo, Tommaso, Diana Cognome: Centanaro, De Rossi, Mukhanova Matricola: 4719894, 4661724, 4633994            
...
int main_()
{
	try {
		...
		string output_csv =
		    "insertionSort1, insertionSort2, insertionSort3, media1, selectionSort1, selectionSort2, selectionSort3, media2, Bubblesort1, Bubblesort2, Bubblesort3, media3, Mergesort1, Mergesort2, Mergesort3, media4, Quicksortbanale1, Quicksortbanale2, Quicksortbanale3, media5, Quicksortrandom1, Quicksortrandom2, Quicksortrandom3 \n";
		vector < int >v1;

		string files[] =
		    { "in-10.txt", "in-10-ordinati.txt", "in-100.txt",
	       "in-100-ordinati.txt", "in-1000.txt", "in-1000-ordinati.txt",
	       "in-10000.txt", "in-10000-ordinati.txt", "in-40000.txt",
	       "in-40000-ordinati.txt" };
		int files_size = 10;
		string file_name;
